...
export class StandardMaterialComponent extends Component {
    constructor(name = "Standard Material", lightingBased = true, detailBased = true, usesEmission = true, usesDisplacement = true, usesLight = true, usesAmbient = true, usesReflection = true, usesOther = true) {
        ...
        coreAttribute.addField("Color", "color", new THREE.Color(0xffffff));
        ...
        if (this.usesEmission) {
            ...
            emissionAttribute.addField("Emissive Color", "emissive", new THREE.Color(0x000000));
        ...
        if (this.detailBased) {
            ...
            detailAttribute.addField("Normal Scale", "normalScale", new THREE.Vector2(1, 1));
    ...
    updateCoreMaterialProperties(attribute = 0) {
        ...
        this.material.color = this.getAttributeFieldValue(attribute, 1);
    ...
    updateEmissionMaterialProperties(attribute = 2) {
        this.material.emissive = this.getAttributeFieldValue(attribute, 0);
    ...
    updateDetailMaterialProperties(attribute = 3) {
        ...
        this.material.normalScale = this.getAttributeFieldValue(attribute, 1);
